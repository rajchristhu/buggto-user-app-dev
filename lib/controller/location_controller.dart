...
class LocationController extends GetxController implements GetxService {
  ...
  Future<AddressModel> getCurrentLocation1(bool fromAddress, {GoogleMapController mapController, LatLng defaultLatLng, bool notify = true}) async {
    _loading = true;
    if(notify) {
      update();
    }
    ...
    _buttonDisabled = !_responseModel.isSuccess;
    _addressModel = AddressModel(
      latitude: _myPosition.latitude.toString(), longitude: _myPosition.longitude.toString(), addressType: 'Current Location',
      zoneId: _responseModel.isSuccess ? _responseModel.zoneIds[0] : 0, zoneIds: _responseModel.zoneIds,
      address: _addressFromGeocode, zoneData: _responseModel.zoneData,
    );
    _loading = false;
