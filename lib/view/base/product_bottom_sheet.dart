  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        ...
        double priceWithAddonsVariation = addonsCost + _variationPrice != 0
            ? (PriceConverter.convertWithDiscount(
                    _variationPrice, _discount, _discountType) *
                productController.quantity)
            : (PriceConverter.convertWithDiscount(
                    _variationPrice + _price, _discount, _discountType) *
                productController.quantity);
        double priceWithAddonsVariationWithoutDiscount =
            ((_price + _variationPrice) * productController.quantity) +
                addonsCost;
        double priceWithVariation =addonsCost + _variationPrice != 0? priceWithAddonsVariation:(_price + _variationPrice);
