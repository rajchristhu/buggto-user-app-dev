  ...
  void initState() {
    ...
    _checkPermission(() async {
      Future.delayed(Duration(milliseconds: 500), () async {
        ...
        _address = await Get.find<LocationController>().getCurrentLocation1(
            true);
        Navigator.pop(context);

      });

      Get.find<OrderController>().clearIndex();
              ...
              return GetBuilder<RestaurantController>(
                ...
                if (restController.restaurant != null) {
                  ...
                  if (_addressList != null) {
                    _addressList.insert(0, _address);
                                    ...
                                    ? CustomButton(
                                      ...
                                      if(_variations[x].name == cart.product.variations[i].name){
                                        _variations[x].values.label.add(cart.product.variations[i].variationValues[j].level);
                                              ...
                                              print(
                                                  'cart product variation: ${jsonEncode(cart.product.variations)}');
                                              print(
                                                  'cart selected variation: ${jsonEncode(_variations)}');
                                              carts.add(Cart(
                                                cart.isCampaign
                                                    ? null
                                                    : cart.product.id,
