                    ...
                    return Column(children: [
                      ...
                      TextButton(
                        ...
                        child: RichText(text: TextSpan(children: [
                          TextSpan(text: 'Non register user? ', style: robotoRegular.copyWith(color: Theme.of(context).disabledColor,fontSize: 18)),
                          TextSpan(text: ' Register now.', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor,fontSize: 18)),
                        ])),
                      ),
                      SizedBox(height: 30),
